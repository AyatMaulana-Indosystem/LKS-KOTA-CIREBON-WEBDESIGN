                ...
                <ul class="nav navbar-nav">
                    ...
                    @if (!Auth::guest())
                        ...
                        @if(Auth::user()->level == 1)
                            ...
                            <li><a href="{{ url('admin/bidang-lomba') }}">Bidang Lomba</a></li>
                            <li><a href="{{ url('admin/registrasi-peserta') }}">Registrasi Peserta</a></li>
                            <li><a href="{{ url('admin/penilaian') }}">Penilaian</a></li>
                        @endif

                        @if(Auth::user()->level == 2)
                            <li><a href="{{ url('peserta/bidang-lomba') }}">Bidang Lomba</a></li>
                        @endif
